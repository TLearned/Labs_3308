...
function loadPlayersPage()
{
	var playermenu = document.getElementById("player_selector");
   	...
   	{
       	var play = players[i].name;
       	nam = nam + "<a class = 'dropdown-item' href='#' onclick = 'switchPlayers("+ i +")'>" + play +"</a>"
   	}
   	playermenu.innerHTML=nam;
}
...
function switchPlayers(playerNum)
{
	...
	document.getElementById("rec_yards").innerHTML = players[playerNum].recieveing_yards;
	var passing = Math.floor(players[playerNum].pass_yards/players[playerNum].games_played);
	var rushing = Math.floor(players[playerNum].rushing_yards/players[playerNum].games_played);
	var recieving = Math.floor(players[playerNum].receiving_yards/players[playerNum].games_played);
	document.getElementById("avg_p_yards").innerHTML = passing;
	document.getElementById("avg_r_yards").innerHTML = rushing;
	document.getElementById("avg_rec_yards").innerHTML = recieving;
}
